Algoritmo Proyecto1KatheFuenzalida
	...
	//Dimensiono arreglo para cumplir con requisito de entregable, la idea es que el usuario ingrese su nùmero de pedido
	Dimension pedidos[1]	
	Escribir "Hola, Bienvenido/a a tu carro de compras"
	//Usuario ingresa su nùmero de pedido
	Para i<-1 Hasta 1 Con Paso 1 Hacer
		Escribir "Ingrese el nùmero de su pedido: "
		Leer pedidos[i]
	Fin Para
		p<-0
		cupon<-0
